$(document).ready(function () {
  ...
  let futureDays1= DateTime.local().plus({days: 1}).toLocaleString();
  let futureDays2 = DateTime.local().plus({days: 2}).toLocaleString();
  let futureDays3 = DateTime.local().plus({days: 3}).toLocaleString();
  let futureDays4 = DateTime.local().plus({days: 4}).toLocaleString();
  let futureDays5 = DateTime.local().plus({days: 5}).toLocaleString();
...
//get five day
            // const forecastURL = forecast + latitude + forecastlon + longitude + url2;
